        ...
        {hasLinkMovie ? (
          useEmbedPlayer ? (
            <div 
              ...
              className={`relative w-full aspect-video bg-black overflow-hidden outline-none focus:outline-none focus:ring-0 ${isFullscreen ? 'rounded-none border-none shadow-none' : 'rounded-2xl md:rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.8)]'}`}
            >
              <iframe
