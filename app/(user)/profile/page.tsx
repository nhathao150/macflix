    ...
    <main className="min-h-screen bg-[#0a0a0c] text-white pb-28 selection:bg-[#F042FF]/30">
      ...
      <div className="w-32 h-32 rounded-full ring-4 ring-white/10 group-hover:ring-[#F042FF]/50 transition-all duration-300 overflow-hidden shadow-2xl">
            ...
            <div className="w-full grid grid-cols-2 gap-3 pt-2 border-t border-white/10">
              <Link href="/history" className="flex flex-col items-center gap-1 p-3 bg-white/5 hover:bg-white/10 rounded-2xl transition-colors group active-scale">
              ...
              <Link href="/favorites" className="flex flex-col items-center gap-1 p-3 bg-white/5 hover:bg-white/10 rounded-2xl transition-colors group active-scale">
