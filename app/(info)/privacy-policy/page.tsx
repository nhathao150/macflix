      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-6 md:p-10 backdrop-blur-sm space-y-8 text-white/70 text-sm md:text-base leading-relaxed">
          ...
          <section className="space-y-4 pt-4 border-t border-white/5">
            ...
            <p>
              Nếu bạn có bất kỳ câu hỏi nào liên quan đến Chính sách bảo mật dữ liệu, xin vui lòng gửi thư cho chúng tôi thông qua trang <Link href="/contact" className="text-[#F042FF] hover:underline font-medium">Liên hệ hỗ trợ</Link>.
            </p>
          </section>
