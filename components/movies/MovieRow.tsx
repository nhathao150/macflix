...
export default function MovieRow({ title, movies, isTrending, onMovieClick, viewMoreLink, rowIndex = 0 }: MovieRowProps) {
  // Tạo một tham chiếu (ref) để trỏ đến thẻ div bọc danh sách phim. Dùng để tính toán và điều khiển việc cuộn (scroll)
  ...
  return (
    <div
      ...
      style={{
        ...
        containIntrinsicSize: 'auto 280px' // Kích thước dự kiến của khối này để tránh nhảy layout
      }}
    >
      ...
      <div className="relative group/row px-4 md:px-12">
        ...
        {/* Khối cuộn (scroll) chứa danh sách các phim */}
        <div
