...
export default function Navbar() {
  ...
  return (
    <div ref={navRef} className="fixed top-0 left-0 w-full z-[100] flex justify-center pointer-events-none">
      <nav className="pointer-events-auto flex items-center justify-between w-[95%] max-w-6xl mt-6 rounded-full px-6 md:px-8 py-3 transition-colors duration-300 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.5)] bg-black/40 border border-white/20">
        ...
        {/* --- CÔNG CỤ PHẢI --- */}
        <div className="flex items-center gap-4 md:gap-6 text-white/80 shrink-0">
          ...
          {/* NÚT TÌM KIẾM MOBILE */}
          <button className="lg:hidden hover:text-white transition-transform hover:scale-110"><Search className="w-5 h-5" /></button>
